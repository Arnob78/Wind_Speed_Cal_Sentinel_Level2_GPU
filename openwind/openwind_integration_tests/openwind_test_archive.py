...
try:
    ...
    print("\nPlease place a module openwind_local_archive on your python path and add paths to local test data if you have any, then update openwind.tests.test_sarwind.py.\n")
except IOError as e:
    print(e)
